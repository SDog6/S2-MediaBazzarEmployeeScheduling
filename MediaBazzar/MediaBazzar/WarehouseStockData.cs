    ...
    public class WarehouseStockData : IDatabaseManager
    {
        ...
        public void Insert(object obj)
        {
            ...
            try
            {
                ...
                string sql = "INSERT INTO warehousestock (StockID, StockName,StockAmount,Price,Brand) VALUES (@stockID, @stockname,@amount,@price,@brand)";
        ...
        public object ReadAll()
        {
            ...
            try
            {
                string sql = "SELECT StockID, StockName,StockAmount,Price,Brand FROM warehousestock;";
                MySqlCommand cmd = new MySqlCommand(sql, conn);
